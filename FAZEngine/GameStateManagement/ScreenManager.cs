...
namespace GameStateManagement
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        /// <summary>
        /// Gets the render target that the screen manager is drawing on
        /// </summary>
        ...
        /// <summary>
        /// Gets the viewport as if the game is running in native 1080p.
        /// May not be the same as GraphicsDevice.Viewport.
        /// </summary>
        public Viewport Viewport
        {
            get { return new Viewport(0, 0, GlobalHelper.GameWidth, GlobalHelper.GameHeight); }
        }
        ...
        protected override void LoadContent()
        {
            ...
            font2 = content.Load<SpriteFont>(@"fonts\menuTitle");
            font3 = content.Load<SpriteFont>(@"fonts\menuMirror");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            input.Update(Microsoft.Xna.Framework.Input.GamePadDeadZone.IndependentAxes);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (!isNative)
            {
                ...
                GraphicsDevice.Clear(Color.Black);
                spriteBatch.Begin(SpriteSortMode.Immediate, BlendState.Opaque, GlobalHelper.SamplerState, DepthStencilState.None, GraphicsDevice.RasterizerState, null);
